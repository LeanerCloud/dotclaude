---
name: project-docs
description: The `.project-docs/` knowledge-base layout, ADR and runbook templates, and the
  `known-issues.md` convention. Invoke when setting up, updating, or consulting project
  documentation.
---
